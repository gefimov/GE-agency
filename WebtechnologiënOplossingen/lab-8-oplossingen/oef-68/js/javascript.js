...
let totalAge = 0, maleCounter = 0, elderlyCounter = 0;
...
showText("Er zijn " + maleCounter + " mannen, " + (demoData.length - maleCounter) + " vrouwen en " + elderlyCounter + " personen ouder dan 30.", "mainHeading");